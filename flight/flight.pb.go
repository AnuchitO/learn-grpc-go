...
var file_flight_proto_rawDesc = []byte{
	...
	,
...
var file_flight_proto_goTypes = []any{
	...
	(*FlightList)(nil),    // 1: flight.FlightList
	(*emptypb.Empty)(nil), // 2: google.protobuf.Empty
}
var file_flight_proto_depIdxs = []int32{
	0, // 0: flight.FlightList.flights:type_name -> flight.Flight
	0, // 1: flight.Flights.GetFlight:input_type -> flight.Flight
	2, // 2: flight.Flights.GetFlightList:input_type -> google.protobuf.Empty
	0, // 3: flight.Flights.GetFlight:output_type -> flight.Flight
	0, // 4: flight.Flights.GetFlightList:output_type -> flight.Flight
...
func file_flight_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_flight_proto_msgTypes[1].Exporter = func(v any, i int) any {
